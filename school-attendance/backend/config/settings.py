...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='school_attendance'),
...
CELERY_BEAT_SCHEDULE = {
    'check-daily-absences': {
        ...
        'schedule': 3600.0,  # Every hour (change to crontab(hour=10, minute=0) for daily at 10 AM)
    },
    'generate-monthly-reports': {
        'task': 'apps.reports.tasks.generate_monthly_report',
        'schedule': 3600.0,  # Every hour (change to crontab(day_of_month=1, hour=0, minute=0) for monthly)
    },
}
...
FACE_DETECTION_MODEL = config('FACE_DETECTION_MODEL', default='cnn')
